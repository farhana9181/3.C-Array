"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.unixRead=void 0;const util_1=require("util"),fs_1=require("fs"),errors_1=require("./errors"),debug_1=__importDefault(require("debug")),logger=(0,debug_1.default)("serialport/bindings-cpp/unixRead"),readAsync=(0,util_1.promisify)(fs_1.read),readable=e=>new Promise(((r,o)=>{if(!e.poller)throw new Error("No poller on bindings");e.poller.once("readable",(e=>e?o(e):r()))})),unixRead=async({binding:e,buffer:r,offset:o,length:n,fsReadAsync:i=readAsync})=>{if(logger("Starting read"),!e.isOpen||!e.fd)throw new errors_1.BindingsError("Port is not open",{canceled:!0});try{const{bytesRead:t}=await i(e.fd,r,o,n,null);return 0===t?(0,exports.unixRead)({binding:e,buffer:r,offset:o,length:n,fsReadAsync:i}):(logger("Finished read",t,"bytes"),{bytesRead:t,buffer:r})}catch(t){if(logger("read error",t),"EAGAIN"===t.code||"EWOULDBLOCK"===t.code||"EINTR"===t.code){if(!e.isOpen)throw new errors_1.BindingsError("Port is not open",{canceled:!0});return logger("waiting for readable because of code:",t.code),await readable(e),(0,exports.unixRead)({binding:e,buffer:r,offset:o,length:n,fsReadAsync:i})}throw("EBADF"===t.code||"ENXIO"===t.code||"UNKNOWN"===t.code||-1===t.errno)&&(t.disconnect=!0,logger("disconnecting",t)),t}};exports.unixRead=unixRead;
// SIG // Begin signature block
// SIG // MIIn4QYJKoZIhvcNAQcCoIIn0jCCJ84CAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // N3ABPvZxccTVid7xPGNmFt0WUfrE+zncOmqLfb2S6cig
...
// SIG // SIb3DQEJBDEiBCC/9hxrA5IrCSuA8dqUHRkIKdzKKYHt
// SIG // vmOcPDMMxPMZ2DBCBgorBgEEAYI3AgEMMTQwMqAUgBIA
// SIG // TQBpAGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5t
// SIG // aWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAAHp
// SIG // sS+191srLHtoBGf3MjDU+3GHgwkLGQwSUQqWtzV93O6m
// SIG // 2cJuY6GKWbK5TX8GT62+knmhGFCfRrokdTTxCllnfNfb
// SIG // lg2zptdTmDBSm2/a62owqf28bthmDwpH5tnaHwiTAj/J
// SIG // 060KnPnM8L0o9dBjYZNBm7Xm3GRdOaJb8iFv5kNO0iLF
// SIG // QL7T5Yd2vCXsCTGtH9fVRzg7uy0WhMn0TfOl/A/CBuOE
// SIG // o7xDiMty1B2oLySLKrkeHQ9SrhWDNv8JXcosd+YMxOUb
// SIG // Kt3Ne0HnH3GQ+gH+1c0noUIzz5j2+GH2BBfR5NDqn4IB
// SIG // hkGnYRHPg2ef1iBo8/ZUZuRutuu+ECGhghcpMIIXJQYK
...
// SIG // AwEwMTANBglghkgBZQMEAgEFAAQg4JAKnLz5e/Aum/Rx
// SIG // piwE7wLjjyL8YBbpWD/nJO6RADQCBmP3WinGfBgTMjAy
// SIG // MzAzMjAxOTE3MjQuNzIxWjAEgAIB9KCB2KSB1TCB0jEL
// SIG // MAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24x
// SIG // EDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
...
// SIG // hvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIDNDdhVi5X3Y
// SIG // 1/C792TvmOYEn0BneM6ZESbXkzkGdJHDMIH6BgsqhkiG
...
// SIG // B5kb8E/434Ux/bjOyTANBgkqhkiG9w0BAQsFAASCAgBj
// SIG // bfQGqUv8+65hOfhRUXzfBvQ5kWWvZ69vsFBsx/NA20hE
// SIG // DxUAw5SYloOunNYjEItEe85L7wkKh3deI8B2GjHQsdbN
// SIG // H38SvJ+GUVgMsbadYAsuxo/1T7qlxSdB8yKTE+enPYxX
// SIG // Iil8Y9zq6/jhWItDPZv5bDRLVActebbE0orQ1X2ExWf0
// SIG // 5ybeKXMn+TubcgZsHbk4m0qLxmZwC1jwbU6dxD+yjzmx
// SIG // uKEczy8Z2oXVkfr/Z3vaobTasVmZrWLmOBz2cPYH7W94
// SIG // kOCNkqGDO5XGNuuGikyurqt/m+BHLIqhzPzpEOhrJ7th
// SIG // OUKEYw2SbuRO3FVYK3AGEe3bVxQSabrSVsrWfa5o4WtW
// SIG // L1CJE0MgdPYzhZnYo2EIhdFgbq/XBXD8uT7k3lQts5EF
// SIG // oVbNzswi8Ke7o6C1GVGuFfAgyRohise5IFL2ABKtX6ec
// SIG // UoMTUcWUhNK1Gq06asSuDHe4AfD3oEfzjT0BNFi6JU+c
// SIG // AgNAREpW01YTCqTpyPWZVWxy5CRJhnuc9pvFXx3dSUSh
// SIG // JuBnq4/hlBwIok2CmOSg1/0wYi5bMw8KK15xahRWqiYf
// SIG // kFt/f3es9f3rvmtllUJ7NwBQiZzQ4Pvh8D+BORnb0l7D
// SIG // 4HXc2aj81Bkik395lyrXUkZitmmMSSd+PcAx3vFokzT0
// SIG // jk40tV+DiaoyNBKAOw1LZg==
