"use strict";var __importDefault=this&&this.__importDefault||function(n){return n&&n.__esModule?n:{default:n}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.asyncWrite=exports.asyncRead=exports.asyncUpdate=exports.asyncSet=exports.asyncOpen=exports.asyncList=exports.asyncGetBaudRate=exports.asyncGet=exports.asyncFlush=exports.asyncDrain=exports.asyncClose=void 0;const node_gyp_build_1=__importDefault(require("node-gyp-build")),util_1=require("util"),path_1=require("path"),binding=(0,node_gyp_build_1.default)((0,path_1.join)(__dirname,"../"));exports.asyncClose=binding.close?(0,util_1.promisify)(binding.close):async()=>{throw new Error('"binding.close" Method not implemented')},exports.asyncDrain=binding.drain?(0,util_1.promisify)(binding.drain):async()=>{throw new Error('"binding.drain" Method not implemented')},exports.asyncFlush=binding.flush?(0,util_1.promisify)(binding.flush):async()=>{throw new Error('"binding.flush" Method not implemented')},exports.asyncGet=binding.get?(0,util_1.promisify)(binding.get):async()=>{throw new Error('"binding.get" Method not implemented')},exports.asyncGetBaudRate=binding.getBaudRate?(0,util_1.promisify)(binding.getBaudRate):async()=>{throw new Error('"binding.getBaudRate" Method not implemented')},exports.asyncList=binding.list?(0,util_1.promisify)(binding.list):async()=>{throw new Error('"binding.list" Method not implemented')},exports.asyncOpen=binding.open?(0,util_1.promisify)(binding.open):async()=>{throw new Error('"binding.open" Method not implemented')},exports.asyncSet=binding.set?(0,util_1.promisify)(binding.set):async()=>{throw new Error('"binding.set" Method not implemented')},exports.asyncUpdate=binding.update?(0,util_1.promisify)(binding.update):async()=>{throw new Error('"binding.update" Method not implemented')},exports.asyncRead=binding.read?(0,util_1.promisify)(binding.read):async()=>{throw new Error('"binding.read" Method not implemented')},exports.asyncWrite=binding.read?(0,util_1.promisify)(binding.write):async()=>{throw new Error('"binding.write" Method not implemented')};
// SIG // Begin signature block
// SIG // MIIn0gYJKoZIhvcNAQcCoIInwzCCJ78CAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // wuncWtozvDa1bhLW7DmtbkV+ihmZtVfrGid5V/+EAxCg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCoEJSK
// SIG // l9utOtiYQj3F2EZj+dqt/IOUV+uLHzQ6MP3W+DBCBgor
// SIG // BgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBm
// SIG // AHShGoAYaHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0G
// SIG // CSqGSIb3DQEBAQUABIIBACooyL6F3Hdf5kBAK6L/e6mi
// SIG // 06EdmaePo0hFH0OkhJJobwHwk4j2cjlL6L5KV5cWma0e
// SIG // jjCo1uv++MQMBiC97pgk0h+xCdjCNDdL0WMMwP8O8NYE
// SIG // YBEbW34lmY1XuvL4v24rVDU97TZDhRFcotSHDym54J4K
// SIG // yGUUYbxqAfOx8YUAYrkmIrFlwfl2ECMAWc+g1N2zMJz9
// SIG // 10QN/y62YXP8mG0JxEuEg3PV4iqLLK2Kc5anzG5TlRGk
// SIG // kn4mF+uo/SlJWC3HTIc6LyBKZqfKc9lRUkmrEH7KE0w0
// SIG // UiHA0J/KJ94cWEqutxZX4lf2/6BEwgWEToMYsaKG5sU7
// SIG // j6iAWSsg33qhghcpMIIXJQYKKwYBBAGCNwMDATGCFxUw
...
// SIG // AgEFAAQgAqcxHESKqMY4ehQHmGmEhGozQg+JOnpeiG8H
// SIG // aI/nNX0CBmP3WhUazhgTMjAyMzAzMjAxOTE3MjcuNDI3
...
// SIG // hvcNAQkEMSIEIHeD1JwQW6stg1rA653+hc4SeXNi03tp
// SIG // KSjQY+NCrMobMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB
...
// SIG // BgkqhkiG9w0BAQsFAASCAgBRe3oK7AMpO+X3oMTGcbVO
// SIG // cGrGWU1fid8hhQJ864/wq0k4KF0QJgUhIzXfn11q5y6/
// SIG // LSqaK1heoXRL2V+LaIMSIC2z1EwXjIUdIO6T/CS2N/oD
// SIG // 6GNTbm0Ed25obRFEae8rDAPPlkqIUePETGq7GcA36Ej2
// SIG // FIOq5q6PknA7QHwPG6Kxt3PQkAouemvNF0imO3I+Ak3k
// SIG // ipTNkqk/7F+JR0q6uextqf+pqKDa0guVIy3s7Grb3J0K
// SIG // Gx/m4kuUjGQGKxIlcNiJKSkzckbwUcuDYaPQFe5xdFrP
// SIG // 8dJrlDUEoWKxu3paaKAKP3BcHWaiUvdtJdikG/gmJTNd
// SIG // qLdzxj9xS3a1DwFmY9TDNq2u7yLlBoW84119ex2Q1oDa
// SIG // 25km4lC702Qa9FWz36IyEGhu5vKk8Z56xoHQ5xagwWQ1
// SIG // BPLO+O70ehFqUoU2mlPAct2KN1IiCMgSyVkWBzXyXAOt
// SIG // G2437OGar9/B6Qxy523Rj+NkLv6xL5VyJKNkfV1GD/j/
// SIG // toe+iEe6iPHy0qpVzpXyoy7UeyOu6Vtf1Halk6SYgLe+
// SIG // EkqsJ8EJvFkjAGZuRYEmTFf6asmkGuY40XMa/qQ72qh3
// SIG // Y8KNFXUzfBTHMUo6+MPO4Hq3VFGREqEDQp05T8hJDj7t
// SIG // l6XkEm4Fsk+9w1GTqd53ioumMU00UjIqni5k0RoJghAiMw==
