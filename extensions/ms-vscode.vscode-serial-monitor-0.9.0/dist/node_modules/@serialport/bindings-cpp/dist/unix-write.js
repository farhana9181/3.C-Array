"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.unixWrite=void 0;const fs_1=require("fs"),debug_1=__importDefault(require("debug")),util_1=require("util"),logger=(0,debug_1.default)("serialport/bindings-cpp/unixWrite"),writeAsync=(0,util_1.promisify)(fs_1.write),writable=e=>new Promise(((r,t)=>{e.poller.once("writable",(e=>e?t(e):r()))})),unixWrite=async({binding:e,buffer:r,offset:t=0,fsWriteAsync:i=writeAsync})=>{const o=r.length-t;if(logger("Starting write",r.length,"bytes offset",t,"bytesToWrite",o),!e.isOpen||!e.fd)throw new Error("Port is not open");try{const{bytesWritten:n}=await i(e.fd,r,t,o);if(logger("write returned: wrote",n,"bytes"),n+t<r.length){if(!e.isOpen)throw new Error("Port is not open");return(0,exports.unixWrite)({binding:e,buffer:r,offset:n+t,fsWriteAsync:i})}logger("Finished writing",n+t,"bytes")}catch(o){if(logger("write errored",o),"EAGAIN"===o.code||"EWOULDBLOCK"===o.code||"EINTR"===o.code){if(!e.isOpen)throw new Error("Port is not open");return logger("waiting for writable because of code:",o.code),await writable(e),(0,exports.unixWrite)({binding:e,buffer:r,offset:t,fsWriteAsync:i})}throw("EBADF"===o.code||"ENXIO"===o.code||"UNKNOWN"===o.code||-1===o.errno)&&(o.disconnect=!0,logger("disconnecting",o)),logger("error",o),o}};exports.unixWrite=unixWrite;
// SIG // Begin signature block
// SIG // MIIn0gYJKoZIhvcNAQcCoIInwzCCJ78CAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // wCJTCeBKRyQErk+HSOrNtiaH/izLxxmeLFvR1+PM//Kg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDXMcnQ
// SIG // ppirsC2bSoDQpwUq4AQ3gogoqUuU0JOdKtokRzBCBgor
// SIG // BgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBm
// SIG // AHShGoAYaHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0G
// SIG // CSqGSIb3DQEBAQUABIIBAFSoi4pD9SFLKszPzEfckclE
// SIG // fDMB24UIUspKKYP1fW24KCVPhFjztCLi6uYG3D8x9coA
// SIG // 80Wez1KHnrfEtDXWG+LyHCYQ9rJa55QjsQwana1iFEEw
// SIG // 5NxMwh5zFMoxfxwR830KkG6GobBdWlHg0IZnbMajyDry
// SIG // u+cCK6GDV/mJN6FK3LT+fNdJw8JkcqTS96S9xz8Q1sek
// SIG // PP+naCtAX9EzQp5WE6UxBz68A9WH4qJH6oQdkTnPx+Mw
// SIG // 33ggl7Esjgotm0VUG0oXb2T5FKirG8rMdXzRJ9jcygic
// SIG // dulVVzYDFIjLbGRwQv51TaQ1wTAYmxIu83Gc4/vy4dgo
// SIG // B/YAG+6Y/aqhghcpMIIXJQYKKwYBBAGCNwMDATGCFxUw
...
// SIG // AgEFAAQgWN/ccY+zhENMIpVfgR3lQwK0r2bix9sxHR0n
// SIG // oNz6XkUCBmP3WhUaWhgTMjAyMzAzMjAxOTE3MjUuODY3
...
// SIG // hvcNAQkEMSIEILNtG+ZekPSQPWeR72iazAZzdiu0vuNn
// SIG // 3CjJrgKtNAkPMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB
...
// SIG // BgkqhkiG9w0BAQsFAASCAgB7As3sUUPslIm6bAronsLa
// SIG // ucD6sihqeUlxTY0hRbKB2dWokRfgVmNaV2DZ5jvjeg4S
// SIG // TLvOGSGX9/lanGx02T66xIsiyiFNWit2cD5zRINw3aI7
// SIG // sodqgy7Cqz/X2vBI5vBgSpH5WvZp7sJ0VTU3uoP15Jp7
// SIG // u3M6JnlmzFcrfDi3LuKYAxg1PKtegUk26hcNFORWOhbD
// SIG // yKc9a8ra4nQrd0k2cbKBCVcjw4nmf/ofy9TMwLtXlfFk
// SIG // W9/fYAqZ88YDe+ZLU80t7LAK6n8aeFXUwLUFaCRdLUt/
// SIG // TUkfoOhegg2Nl4Tw3PCEjyScEXUQPCvWuUkj84dpjaIy
// SIG // 6/mbdNYYVBMqrB+B8hOJEnd96ZnH3abtCy5nsZb8/3Nj
// SIG // 7TuUI60BWl+yz7MiQwIsZudBXoZsWJAJ+jSK0TwSP32b
// SIG // E3RI5xrfdFuqJjylQ+YDnqbAQo+Zt3I8WBRK+1X1NK4B
// SIG // otH6b5+AOHCjtOVOzsfFoqynNCK3agolfiQx+gdIg4kb
// SIG // O/MvfM75QYxDHiZHNPyLvfisX5IFIihxolX9tEo9QsWs
// SIG // 8sIyX3cHL0AK/mYRSH84AYeCRhnZLpEVGFWVzqDjhDhl
// SIG // 6H8WmjFnWYIyTUJuMiGDYwfoiLQKSPkRH+jhvpshk+DN
// SIG // kNalgKwkoTaqT2nkts1Nc+V/l9fXQJ0XeHLnyqaQyn8jNQ==
