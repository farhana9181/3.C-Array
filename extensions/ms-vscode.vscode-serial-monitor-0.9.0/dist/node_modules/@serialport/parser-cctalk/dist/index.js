"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.CCTalkParser=void 0;const stream_1=require("stream");class CCTalkParser extends stream_1.Transform{constructor(s=50){super(),this.array=[],this.cursor=0,this.lastByteFetchTime=0,this.maxDelayBetweenBytesMs=s}_transform(s,r,t){if(this.maxDelayBetweenBytesMs>0){const s=Date.now();s-this.lastByteFetchTime>this.maxDelayBetweenBytesMs&&(this.array=[],this.cursor=0),this.lastByteFetchTime=s}for(this.cursor+=s.length,Array.from(s).map((s=>this.array.push(s)));this.cursor>1&&this.cursor>=this.array[1]+5;){const s=this.array[1]+5,r=Buffer.from(this.array.slice(0,s));this.array=this.array.slice(r.length,this.array.length),this.cursor-=s,this.push(r)}t()}}exports.CCTalkParser=CCTalkParser;
// SIG // Begin signature block
// SIG // MIIn5AYJKoZIhvcNAQcCoIIn1TCCJ9ECAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // XoWrOaSXVPSnN6P27Whcp6rf6QB2vmt1PlOtoXgKcUGg
...
// SIG // SIb3DQEJBDEiBCCe2K3fwFp4LrbYWtPM5Q8Urb/UArYK
// SIG // ZCjpNa2mnoFq2jBCBgorBgEEAYI3AgEMMTQwMqAUgBIA
// SIG // TQBpAGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5t
// SIG // aWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAAbD
// SIG // pkO3LszKuSmE5rR4rrS9e/kPoui67myL2aJ2tPOLL3uz
// SIG // mjoQ/83wkHhGW0oLnM2omFxlrfibJdWBm2YzXDJYJTO+
// SIG // r6nWJ7au2MBqM+kkIAzA7G4jHBNRQi5O+afbgcAQrT+R
// SIG // dTuLgI870ac4h21T9Ap23ItZRaLtcMMWJlQ0NSc7/FzE
// SIG // fjfXVr9QSO4GEGcGuJYJu/gsFHF5ZOLKfPD95l+EDaUt
// SIG // jwBHXh+LYfCrSuKpAHVHoOc+Y4PHI0Va8iKmPDCeY6xk
// SIG // hDspeywwXCYywBmen4FxK+TzhwyH2pJb+zK4Foc+Phkr
// SIG // 94PMCezzjOB8fA4STCM3s3PH3YH56pShghcsMIIXKAYK
...
// SIG // AwEwMTANBglghkgBZQMEAgEFAAQgg8n1aF8rmkcKIWS9
// SIG // tHeuC3Q+26ud/5jpaLMW9PDXEpICBmP3WnqWohgTMjAy
// SIG // MzAzMjAxOTE3MjQuODM5WjAEgAIB9KCB2KSB1TCB0jEL
// SIG // MAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24x
// SIG // EDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
...
// SIG // KoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIHWnSsaa
// SIG // 7B6onOnpWcsCXp/PgXyvj+3zJTBlcOAwBIZuMIH6Bgsq
...
// SIG // AgCQoC+wMFlBtu1cxA4dJqPY19GCK+ct8djx1gWwoOcI
// SIG // r9atrNmtcvDgIjxjFKtuxgRZa6Twu9m8ld2+RWciFW7V
// SIG // VbX/kHUB2OYlsxDbNUFw473IRu3KY2qFa9ZE+AfsGCRO
// SIG // QH/W2LA4/RrLodvSFneMZLLtq+EtKz1IN35B1Aqh0q2H
// SIG // IrPnlpYUqJIeI7RCG+s1lV3ctb9xHn+c1qo8cNk/nwhd
// SIG // w+fxOwPocYvjkBq99N2cRgshmKwQRDDfuc+8qFLP5wTi
// SIG // y3qqgOTXYKTlQ9C9fX9r3j8B2dSrlq+KArm+54ryvWl/
// SIG // EbBNUBBZwevHK0wN19LvhahAwShodubTizdDN2nieTi3
// SIG // KIjLXI5ec/njOYu8CGFtNfYgtMrUkrZKaHCUd8kB2F8l
// SIG // /B7ha7rL0wYB7JyrW+kYpR3gkJrI+NLB9Upf37fEv1gg
// SIG // Xw8kcB9cXYypmhLi4SpstmPKfgCyZscBgBL6Y5ZhGQ+c
// SIG // 78bVVofDIuUgyXR7YupQwfVPVtBd+4B7OAeZ6Ns0xGjX
// SIG // VJn/9JXsWkZipjl0uUM8ha1LMFkorRMv4rkBtQzMaWBC
// SIG // SzgnHEbbHsHKYEsSmgqIbWi3dwkBKmSlHgd/4BJVhlxR
// SIG // x0JMskzF5VTwBiNVU11mJU8JsGUuu1lm6n7h1V5bTfpQ
// SIG // QYHUYhqdQu9wA399cUFKGv8Esg==
